...
5. What is a link shortener? You should be able to shorten a long URL like
   ...
   much shorter. Shortened URL would be something like `http://localhost/s/xYz123`.
6. There should be a different url for the link admin page.
